            ...
            <div className='row mt-4'>
              ...
              <div className='col-lg-4 mb-4'>
                <article className=' card-resume p-4 pt-3'>
                  <div className='flex-row gap-2 d-flex pb-2 border-bottom border-1'>
                    <div className='flex-column d-flex'>
                      <strong className="fs-4">Emey U</strong>
                      <div className='flex-row  d-flex gap-1'>
                        <span>Windows and mobile developer</span>
                      </div>
                    </div>
                  </div>
                  <div className="flex-column gap-2 border-bottom border-1 d-flex pt-2">
                    <strong>Summary</strong>
                    <p className='text-desc fs-6'>
                      She is a desktop application developer. She has experience developing C# and Java languages. She has experience in designing and implementing relational databases. She holds a Bachelor's degree in Software Engineering from the University of Tripoli.</p>
                  </div>
                  <div className='d-flex flex-row gap-1 tag-lang flex-wrap pt-3'>
                    <span>C#</span>
                    <span>.NET</span>
